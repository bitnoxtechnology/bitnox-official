    ...
    <div className="conclusion-container" ref={containerRef}>
      ...
      <section className="success-section">
        <div className="section-header">
          ...
          <p className="testimonial-subtitle">
            We have provided solutions for more than 100 clients worldwide
          </p>
          <p className="section-description">
            Our professionalism has helped us achieve this milestone in our
            business. We provide the best solutions, work with us today!
          </p>
        </div>
      ...
      <section className="skills-section">
        <div className="section-header">
          ...
          <p className="section-description">
            Bitnox Technology is filled with world-class talent that specializes
            in providing comprehensive range of services to help businesses
      ...
      <section className="contact-section">
        <div className="section-header">
          ...
          <p className="testimonial-subtitle">
            Let's breathe your concept into existence
          </p>
        </div>
