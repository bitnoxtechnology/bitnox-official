...
export const CLIENT_LOGOS: readonly ClientLogo[] = [
  {
    ...
    src: "/brands/provision.webp",
    width: 150,
    height: 40,
    placeholder: false,
  },
  {
    name: "TranSpendly Global Innovation Ltd",
    src: "/brands/transpendly.webp",
    width: 150,
    height: 40,
    placeholder: false,
  },
  {
    name: "Remigella International",
    src: "/brands/remigella.webp",
    width: 150,
    height: 40,
    placeholder: false,
  },
  {
    name: "Clean Axis Ltd",
    src: "/brands/cleanaxis.webp",
    width: 150,
    height: 40,
    placeholder: false,
  },
  {
    name: "Babadel Estates Limited",
    src: "/brands/babadel.webp",
    width: 150,
    height: 40,
    placeholder: false,
  },
