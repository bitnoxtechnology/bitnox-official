 ...
 * policy described device fingerprinting, a cookie banner, bcrypt and AWS. None of those is
      ...
      blocks: [
        ...
        { type: "subheading", text: "What is collected automatically" },
        {
          ...
          items: [
            ...
            "Where a Google Tag Manager container is configured, the analytics data that container collects, subject to Google's own policies.",
          ],
        },
        {
          type: "paragraph",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          type: "list",
          items: [
            "**A session cookie**, set only when somebody signs in to the admin. It holds a signed session identifier, nothing about you, and it is required for signing in to work.",
            "**Analytics**, only where a Google Tag Manager container has been configured for the site. That container is the only third party able to set anything here, and it collects what Google's own policies describe.",
          ],
        },
        {
          type: "paragraph",
